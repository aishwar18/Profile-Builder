...
se_a[0] = "";
se_a[1]="1|2|3|4|5|6|7|8";
se_a[2]="1|2|3|4";

function print_college(college_id){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var option_str = document.getElementById(college_id);
	option_str.length=0;
	option_str.options[0] = new Option('Select College','');
...
function password_visibility(y) {
  ...
  function confirm_password_visibility(y) {
...
function confirm_password_check()
{
  ...
  var z;
  var pi = "Please enter the confirm password correctly to submit";
  if(x==y)
  {
		z="Password Matched";
		btn.disabled = false;
