...
toggle.click()
time.sleep(1)
see=driver.find_element_by_xpath("//div[@onclick='favourites_delete()'][@class='overlay']")
see.click()
time.sleep(2)
check=driver.find_element_by_id("aoi+")
check.click()
time.sleep(2)
delete=driver.find_element_by_id('submit_btn')
delete.click()
time.sleep(2)
